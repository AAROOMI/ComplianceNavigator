...
import { Shield, QrCode, FileSignature, FileText, CheckCircle2, Zap, ArrowRight, BarChart3, Scan, Download, Eye, Users, Clock, Archive } from "lucide-react";
        ...
        <div className="text-center space-y-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">
              Welcome to ComplianceNavigator, {currentUser.firstName}!
            </h1>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Join organizations who trust ComplianceNavigator for comprehensive document lifecycle management 
